...
\author{
  \IEEEauthorblockN{Cristóbal Flores Villegas,
                    Benito Camelo%
                    % ← agregar resto de integrantes aquí
                   }
  \IEEEauthorblockA{
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/grd_distribucion.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/demograficos.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/diag_proced_por_paciente.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/comparacion_modelos.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/curvas_entrenamiento_mlp.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{../reports/confusion_matrix_top15.png}
